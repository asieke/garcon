...
<style>
	...
	@media (max-width: 480px) {
		...
		h1 { font-size: 14px; }
		.columns, .usage-row { grid-template-columns: 48px minmax(54px, 78px) minmax(44px, 1fr) 56px; gap: 6px; padding-right: 8px; padding-left: 13px; }
		.columns { font-size: 8px; letter-spacing: .04em; }
		.usage-row { flex-basis: 24px; min-height: 24px; padding-left: 8px; font-size: 10px; }
		.provider-label { gap: 5px; white-space: nowrap; }
